...
if __name__ == "__main__":
    ...
    yolo_labels_with_boxes = helper.prepare_YOLO_Data(bounding_boxes, confidences, class_ids)
    ...
    webcrawler.draw_bboxes_with_labels(frame, labels_with_boxes, yolo_labels_with_boxes)
